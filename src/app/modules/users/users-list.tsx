...
import { UserId, usersSelectors, usersSlice } from "./users.slice";

export function UsersList() {
  const [sortType, setSortType] = useState<"asc" | "desc">("asc");

  const sortedUsers = useAppSelector((state) =>
    usersSelectors.selectSortedUsers(state, sortType)
  );

  const selectedUserId = useAppSelector(usersSelectors.selectSelectedUserId);
